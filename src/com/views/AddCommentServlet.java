...
public class AddCommentServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		pw.write("<form action='AddCommentLogicServlet?id="+postId+"' method='post' style='display:flex; width:100%;align-items: center;'>");
		pw.write("<textarea class='form-control' name='comment-content' id='exampleFormControlTextarea1' rows='3' style='height: 60px;width: 71%;margin: 5px;'></textarea><button type='submit' class='btn btn-primary' style='margin: 5px;'>Comment</button>");
		pw.write("</form>");
		pw.write("</div>");
